...
def install_route_hooks() -> None:
    ...
    if getattr(UiServerRuntime, "_bio_oauth_route_hooks_installed", False):
        return
    ...
    UiServerRuntime._bio_oauth_route_hooks_installed = True


def is_installed() -> bool:
    from helpers.ui_server import UiServerRuntime

    return bool(getattr(UiServerRuntime, "_bio_oauth_route_hooks_installed", False))
