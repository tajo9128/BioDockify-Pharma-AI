...
class DiscoveryCardsExtension(Extension):
    ...
    async def execute(self, banners: list = [], frontend_context: dict = {}, **kwargs):
        ...
        banners.append({
            ...
            "description": "Extend BioDockify AI with integrations, tools, and automations from the community.",
        ...
        if not telegram_config.get("bot_token"):
            banners.append({
                ...
                "description": "Chat with BioDockify AI from Telegram wherever you are.",
        ...
        if not email_is_configured:
            banners.append({
                ...
                "type": "feature",
                "title": "Setup Email",
                "description": "Let BioDockify AI read and send emails on your behalf.",
        ...
        if not whatsapp_config.get("phone_number_id"):
            banners.append({
                ...
                "description": "Send and receive WhatsApp messages through bio.",
