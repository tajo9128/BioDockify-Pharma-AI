...
# BioDockify AI
### AI Research Assistant for PhD Scholars
...
[![Version](https://img.shields.io/badge/version-3.7.0-green.svg)](https://github.com/tajo9128/BioDockify-pharma-research-ai)
...
- 🌐 **Multi-Provider AI** - 11 AI providers (Ollama, OpenAI, Anthropic, DeepSeek, Moonshot, Qwen, Zhipu, MiniMax, Yi)
- 🔬 **Literature Search** - PubMed, Semantic Scholar, arXiv
- 🧠 **Deep Research** - Web + papers
- 📚 **Knowledge Base** - Store & search documents with file upload
- 📝 **Writing** - Thesis & review templates
- 🎓 **PhD Journey** - Project tracking from topic to defense
- ⚙️ **Settings** - Full configuration with API keys
- 🛠️ **Skills System** - Custom AI skills
...
On first launch, automatically checks:
...
https://hub.docker.com/r/tajo9128/biodockify-ai

---

## Support

- Issues: https://github.com/tajo9128/BioDockify-pharma-research-ai/issues
