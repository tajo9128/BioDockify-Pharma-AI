...
def print_troubleshooting():
    ...
    print("   - Make sure BioDockify AI is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ BioDockify AI server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to BioDockify AI server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start BioDockify AI server if not running")
