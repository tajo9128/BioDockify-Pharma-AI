...
- **Knowledge Base**: 5 tabs — Notebook (doc cards + full reader), Chat with KB, Library, Podcast (TTS), Notes
- **Removed**: standalone Notebook module, Patent Search, Clinical Trials, Benchmark
- **Faculty CMD**: Questions tab (MCQ/short/long/true-false + Bloom's taxonomy)
