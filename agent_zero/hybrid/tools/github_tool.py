...
class GitHubTool:
    ...
    def search_repositories(self, params: dict) -> str:
        ...
        try:
            ...
            resp = requests.get(url, headers=self.headers, params={"q": query, "per_page": 5}, timeout=10)
    ...
    def create_issue(self, params: dict) -> str:
        ...
        try:
            ...
            resp = requests.post(url, headers=self.headers, json={"title": title, "body": body}, timeout=10)
            resp.raise_for_status()
            data = resp.json()
