...
Contributions to improve BioDockify AI are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the BioDockify AI repository on GitHub.
...
- **Code Style:** Follow the existing code style. BioDockify AI generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main BioDockify AI repository.
...
2. **Add an `upstream` remote** that points to `agent0ai/BioDockify-AI`.
...
- **Core bugfixes and docs for BioDockify AI itself:** prepare them in a clean fork/clone of `BioDockify-AI` and open a PR back to the upstream repository.
...
- **Skills:** develop locally in `usr/skills/`, then move stable skills to `skills/` for BioDockify AI contributions or publish them in a dedicated public repository/collection.
...
- The documentation is built using Markdown. We appreciate your contributions even if you don't know Markdown, and look forward to improve BioDockify AI for everyone's benefit.
