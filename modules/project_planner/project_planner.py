...
class ProjectPlanner:
    ...
    async def _recall_similar_projects(
        self, project_title: str, limit: int = 5
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            results = await self.memory_system.search(
                query=f"project {project_title} research tasks plan", limit=limit
            )
...
"""
                ...
                if hasattr(self.hybrid_agent, "execute"):
                    ...
                    try:
                        ...
                        if "```json" in response_json:
                            json_str = (
                                response_json.split("```json")[1]
                                .split("```")[0]
                                .strip()
                            )
                        elif "```" in response_json:
                            json_str = (
                                response_json.split("```")[1].split("```")[0].strip()
                            )
                        else:
    ...
    def _create_default_plan(
        self, project_title: str, project_type: ProjectType
    ) -> Dict[str, Any]:
            ...
            "tasks": [
                {
                    ...
                    "description": f"Conduct comprehensive literature review on {title}",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 40,
                    "depends_on": [],
                },
                {
                    ...
                    "description": "Formulate testable hypotheses based on literature review",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 8,
                    "depends_on": [],
                },
                {
                    ...
                    "description": "Design detailed study protocol including methods and materials",
                    "phase": "preparation",
                    "priority": 1,
                    "estimated_hours": 16,
                    "depends_on": [],
                },
                {
                    ...
                    "description": "Prepare and submit IRB/ethics committee application",
                    "phase": "preparation",
                    "priority": 0,
                    "estimated_hours": 20,
                    "depends_on": [],
                },
                {
                    ...
                    "description": "Execute data collection according to protocol",
                    "phase": "execution",
                    "priority": 1,
                    "estimated_hours": 60,
                    "depends_on": ["Study Protocol Design", "IRB/Ethics Approval"],
                },
                {
                    "title": "Data Analysis",
                ...
                },
                {
                    ...
                    "description": "Draft manuscript including introduction, methods, results, discussion",
                    "phase": "review",
                    "priority": 3,
                    "estimated_hours": 40,
                ...
                },
                {
                    ...
                    "description": "Address reviewer comments and revise manuscript",
                    "phase": "review",
                    "priority": 3,
                    "estimated_hours": 24,
                    "depends_on": ["Manuscript Drafting"],
                },
                {
                    "title": "Final Submission",
                    "description": "Submit final manuscript to target journal",
                    "phase": "finalization",
                    "priority": 4,
                    "estimated_hours": 8,
                    "depends_on": ["Peer Review Response"],
                },
            ],
            "metadata": {
                "total_tasks": 10,
            ...
            "tasks": [
                {
                    ...
                    "description": "Gather and analyze requirements for the project",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 16,
                    "depends_on": [],
                ...
                },
                {
                    ...
                    "description": "Implement frontend components and interactions",
                    "phase": "execution",
                    "priority": 0,
                    "estimated_hours": 80,
                    "depends_on": ["Architecture Design"],
                },
                {
                    ...
                    "priority": 1,
                    "estimated_hours": 48,
                    "depends_on": ["Backend Development", "Frontend Development"],
                },
                {
                    "title": "Deployment",
    ...
    def _writing_template(self, title: str) -> Dict[str, Any]:
        return {
            ...
            "tasks": [
                ...
                {
                    "title": "Review & Edit",
                    "description": "Review and edit manuscript",
                    "phase": "review",
                    "priority": 2,
                    "estimated_hours": 8,
                ...
                {
                    "title": "Final Version",
                    "description": "Produce final version",
                    "phase": "finalization",
                    "priority": 3,
                    "estimated_hours": 4,
                    "depends_on": ["Review & Edit"],
                },
            ],
    ...
    def _review_template(self, title: str) -> Dict[str, Any]:
        return {
            ...
            "tasks": [
                {
                    "title": "Initial Read",
                    "description": "Initial thorough reading",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 4,
                    "depends_on": [],
                },
                {
                    ...
                    "description": "Detailed point-by-point analysis",
                    "phase": "analysis",
                    "priority": 1,
                    "estimated_hours": 8,
                    "depends_on": ["Initial Read"],
                },
                {
                    "title": "Review Report",
    ...
    def _grant_template(self, title: str) -> Dict[str, Any]:
        return {
            ...
            "tasks": [
                {
                    "title": "Concept Note",
                    "description": "Develop concept note",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 8,
                    "depends_on": [],
                },
                {
                    ...
                    "description": "Prepare detailed budget",
                    "phase": "preparation",
                    "priority": 1,
                    "estimated_hours": 16,
                    "depends_on": ["Concept Note"],
                },
                {
                    "title": "Full Proposal Writing",
                    "description": "Write full grant proposal",
                    "phase": "execution",
                    "priority": 0,
                    "estimated_hours": 40,
                    "depends_on": ["Concept Note"],
                },
                {
                    ...
                    "priority": 1,
                    "estimated_hours": 8,
                    "depends_on": ["Full Proposal Writing"],
                },
                {
                    "title": "Final Submission",
                    "description": "Finalize and submit grant",
                    "phase": "finalization",
                    "priority": 0,
                    "estimated_hours": 4,
            ...
            "tasks": [
                {
                    ...
                    "description": "Select target journal",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 4,
                    "depends_on": [],
                ...
                {
                    "title": "Formatting",
                    "description": "Format according to journal guidelines",
                    "phase": "preparation",
                    "priority": 1,
                    "estimated_hours": 8,
                    "depends_on": ["Journal Selection"],
                },
                {
                    "title": "Cover Letter",
                ...
                },
                {
                    ...
                    "description": "Complete online submission process",
                    "phase": "finalization",
                    "priority": 0,
                    "estimated_hours": 4,
                    "depends_on": ["Formatting", "Cover Letter"],
                },
            ],
            "metadata": {"total_tasks": 4},
        }
            ...
            "tasks": [
                {
                    ...
                    "description": "Draft study protocol",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 40,
                    "depends_on": [],
                },
                {
                    ...
                    "priority": 0,
                    "estimated_hours": 80,
                    "depends_on": ["Protocol Draft"],
                },
                {
                    "title": "Site Selection",
                    "description": "Identify and select clinical sites",
                    "phase": "preparation",
                    "priority": 1,
                    "estimated_hours": 40,
                    "depends_on": ["Protocol Draft"],
                },
                {
                    ...
                    "priority": 1,
                    "estimated_hours": 160,
                    "depends_on": ["Regulatory Filing", "Site Selection"],
                },
                {
                    "title": "Data Monitoring",
                    "description": "Ongoing data monitoring",
                    "phase": "execution",
                    "priority": 2,
                    "estimated_hours": 80,
                    "depends_on": ["Patient Recruitment"],
                },
            ],
            "metadata": {"total_tasks": 5},
        }
    ...
    def _thesis_template(self, title: str) -> Dict[str, Any]:
        return {
            ...
            "tasks": [
                {
                    "title": "Proposal",
                    "description": "Write and defend proposal",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 40,
                    "depends_on": [],
                ...
                },
                {
                    ...
                    "description": "Conduct core research",
                    "phase": "execution",
                    "priority": 0,
                    "estimated_hours": 160,
                    "depends_on": ["Proposal"],
                },
                {
                    ...
                    "description": "Write analysis chapter",
                    "phase": "analysis",
                    "priority": 1,
                    "estimated_hours": 40,
                    "depends_on": ["Research/Experiments"],
                },
                {
                    "title": "Conclusion & Filing",
                    "description": "Finalize thesis and file",
                    "phase": "finalization",
                    "priority": 2,
                    "estimated_hours": 20,
                    "depends_on": ["Data Analysis Chapter"],
                },
            ],
            "metadata": {"total_tasks": 5},
        }
    ...
    def _experiment_template(self, title: str) -> Dict[str, Any]:
        return {
            ...
            "tasks": [
                {
                    "title": "Reagent Prep",
                    "description": "Prepare all reagents and materials",
                    "phase": "preparation",
                    "priority": 0,
                    "estimated_hours": 4,
                    "depends_on": [],
                ...
                {
                    "title": "Execution",
                    "description": "Run the laboratory protocol",
                    "phase": "execution",
                    "priority": 0,
                    "estimated_hours": 16,
                    "depends_on": ["Reagent Prep"],
                },
                {
                    "title": "Sample Analysis",
                    "description": "Analyze resulting samples",
                    "phase": "analysis",
                    "priority": 1,
                    "estimated_hours": 8,
                ...
                {
                    "title": "Lab Report",
                    "description": "Document results in lab notebook",
                    "phase": "finalization",
                    "priority": 2,
                    "estimated_hours": 4,
                    "depends_on": ["Sample Analysis"],
                },
            ],
            "metadata": {"total_tasks": 4},
        }
    ...
    def _generic_template(self, title: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "tasks": [
                {
                    "title": "Planning",
                    "description": f"Create detailed plan for {title}",
                    "phase": "planning",
                    "priority": 0,
                    "estimated_hours": 8,
                    "depends_on": [],
                ...
                {
                    "title": "Preparation",
                    "description": "Gather resources and prepare for execution",
                    "phase": "preparation",
                    "priority": 1,
                    "estimated_hours": 16,
                    "depends_on": ["Planning"],
                },
                {
                    ...
                    "description": f"Execute initial phase of {title}",
                    "phase": "execution",
                    "priority": 1,
                    "estimated_hours": 40,
                ...
                },
                {
                    ...
                    "description": f"Execute main phase of {title}",
                    "phase": "execution",
                    "priority": 1,
                    "estimated_hours": 40,
                    "depends_on": ["Execution Phase 1"],
                },
                {
                    "title": "Analysis",
                    ...
                    "priority": 2,
                    "estimated_hours": 24,
                    "depends_on": ["Execution Phase 2"],
                },
                {
                    "title": "Review",
                    "description": "Review and refine work",
                    "phase": "review",
                    "priority": 3,
                    "estimated_hours": 16,
                    "depends_on": ["Analysis"],
                ...
                {
                    "title": "Finalization",
                    "description": "Complete and deliver final output",
                    "phase": "finalization",
                    "priority": 4,
                    "estimated_hours": 16,
                    "depends_on": ["Review"],
...
def get_project_planner(hybrid_agent=None, memory_system=None) -> ProjectPlanner:
    ...
    if _project_planner is None:
        _project_planner = ProjectPlanner(
            hybrid_agent=hybrid_agent, memory_system=memory_system
        )
